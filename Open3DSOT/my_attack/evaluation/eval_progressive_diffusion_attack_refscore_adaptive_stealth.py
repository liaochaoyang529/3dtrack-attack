"""Evaluate adaptive-stealth refscore attack in no-GT mode."""

from my_attack.core.progressive_diffusion_attack_refscore_adaptive_stealth import (
    ADAPTIVE_FAKE_RATIO,
    SMALL_DROP_RATIO,
    STEALTH_LIMITS,
    DriftState,
        ...
        if frame_id == 0:
            ...
            if attack_cfg.enabled:
                def tracker_eval_fn(candidate_input):
                    metrics, _ = nogt_eval.evaluate_input_blackbox(model, candidate_input, ref_bb)
                    return metrics
