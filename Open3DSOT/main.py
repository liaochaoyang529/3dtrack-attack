...
def parse_config():
    ...
    parser.add_argument('--cfg', type=str, default='/workspace/Open3DSOT/Open3DSOT/cfgs/BAT_Car.yaml',help='the config_file')
    parser.add_argument('--checkpoint', type=str, default='/workspace/Open3DSOT/Open3DSOT/pretrained_models/bat_kitti_car.ckpt', help='checkpoint location')
...
if not cfg.test:
    ...
    print(test_loader)
    trainer = pl.Trainer(gpus=1,  default_root_dir=cfg.log_dir,distributed_backend=None,
